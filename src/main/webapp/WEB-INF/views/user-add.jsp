      ...
      <div class="container">
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row mg-b-40">
            <div class="col-md-9">
              <h2 class="az-content-title">Add User</h2>
            </div>
          </div>

          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="az-content-label">Name</div>
              <input class="form-control" placeholder="" type="text" />
            </div>
            <!-- col-4 -->

            <div class="col-lg-6">
              <div class="az-content-label">Email</div>
              <input class="form-control" placeholder="" type="text" />
            </div>
            <!-- col-4 -->
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="az-content-label">Password</div>
              <input class="form-control" placeholder="" type="text" />
            </div>
            <!-- col-4 -->

            <div class="col-lg-6">
              <div class="az-content-label">Role</div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label mg-b-5">Picture</div>
