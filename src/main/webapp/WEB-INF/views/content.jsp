    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <h2 class="az-content-title">Content</h2>

          <div class="az-content-label mg-b-5 mg-b-20">Select Content</div>

          <div class="row row-xs wd-xl-80p">
            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/page" class="btn btn-outline-light btn-block"><i class="fas fa-file cBicon01"></i>Pages</a>
            </div>

            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/resource" class="btn btn-outline-light btn-block"
                ><i class="fas fa-file-alt cBicon02"></i>Resources</a
              >
            </div>

            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/banner" class="btn btn-outline-light btn-block"
                ><i class="fas fa-newspaper cBicon03"></i>Banners</a
              >
            </div>

            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/faqs" class="btn btn-outline-light btn-block"
                ><i class="fas fa-question cBicon01"></i>FAQS</a
              >
            </div>

            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/category" class="btn btn-outline-light btn-block"
                ><i class="fas fa-tags cBicon02"></i>Category</a
              >
            </div>
          </div>

          <div class="row row-xs wd-xl-80p mg-t-20">
            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/tags" class="btn btn-outline-light btn-block"><i class="fas fa-tags cBicon02"></i>Tags</a>
            </div>

            <div class="col-sm-6 col-md-2 mg-t-10 mg-md-t-0">
              <a href="/widgets" class="btn btn-outline-light btn-block"
                ><i class="fas fa-neuter cBicon03"></i>Widgets</a
              >
            </div>
          </div>
