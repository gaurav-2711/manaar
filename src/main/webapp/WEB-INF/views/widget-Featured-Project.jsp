      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          <div class="az-content-breadcrumb">
            <span>Content</span>
            <span>Widget</span>
            <span>Widget Featured Project</span>
          </div>

          <div class="row">
            <div class="col-md-9">
              <h2 class="az-content-title">Widget Featured Project</h2>
            </div>
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <input class="form-control" placeholder="Featured Project" type="text" />
            </div>
            <!-- col-4 -->
          </div>
          <!-- row -->
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <textarea
                ...
                placeholder="Answers to Common Questions about Our Commercial Analytics, Technology Integration, and Venture Management Services"></textarea>
            </div>
            <!-- col -->
          </div>
