      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row mg-b-40">
            <div class="col-md-9">
              <h2 class="az-content-title">Tags</h2>
            </div>
            <div class="col-md-3 float-md-right">
              <form action="tags/addTag">
                <a href="/tags/addTag" class="btn btn-success btn-with-icon btn-block"
                  ><i class="typcn typcn-plus"></i> Add Tag</a
                >
              </form>
            </div>
          </div>
