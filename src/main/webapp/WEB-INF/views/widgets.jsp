      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row mg-b-40">
            <div class="col-md-9">
              <h2 class="az-content-title">Widgets</h2>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-hover mg-b-0">
              <thead>
                <tr>
                  <th class="wd-5p"></th>
                  <th class="wd-35p">Widget Title</th>
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>Impactful investments</td>

                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetImpactfulInvestments" class="btn btn-primary btn-icon"
                ...
                <tr>
                  <td>2</td>
                  <td>Analytics, Integration, Management</td>

                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetSection02" class="btn btn-primary btn-icon"
                        ><i class="typcn typcn-edit"></i
                      ></a>
                      <a class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></a>
                    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetFeatured" class="btn btn-primary btn-icon"
                        ><i class="typcn typcn-edit"></i
                      ></a>
                      <a class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></a>
                    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetKeyInsights" class="btn btn-primary btn-icon"
                        ><i class="typcn typcn-edit"></i
                      ></a>
                      <a class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></a>
                    </div>
                ...
                <tr>
                  <td>2</td>
                  <td>Manaar's MENA Expansion</td>

                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetMenaExpansion" class="btn btn-primary btn-icon"
                        ><i class="typcn typcn-edit"></i
                      ></a>
                      <a class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></a>
                    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-icon-list">
                      <a href="/widgets/widgetNumbers" class="btn btn-primary btn-icon"
                        ><i class="typcn typcn-edit"></i
                      ></a>
                      <a class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></a>
                    </div>
