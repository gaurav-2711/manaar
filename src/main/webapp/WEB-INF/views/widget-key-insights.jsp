      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          <div class="az-content-breadcrumb">
            <span>Content</span>
            <span>Widget</span>
            <span>Widget Key Insights</span>
          </div>

          <div class="row">
            <div class="col-md-9">
              <h2 class="az-content-title">Widget Key Insights</h2>
            </div>
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <input class="form-control" placeholder="Key Insights" type="text" />
            </div>
            <!-- col-4 -->
          </div>
          <!-- row -->
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <textarea
                ...
                placeholder="Insights into Energy Investment, Technology Integration, and Venture Management"></textarea>
            </div>
            <!-- col -->
          </div>
