      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row mg-b-40">
            <div class="col-md-9">
              <h2 class="az-content-title">Banners</h2>
            </div>
            <div class="col-md-3 float-md-right">
              <form action="banner/addBanner">
                <button class="btn btn-success btn-with-icon btn-block">
                  <i class="typcn typcn-edit"></i> Add Banner
                </button>
              </form>
            </div>
          </div>
            ...
            <table class="table table-hover mg-b-0">
              <thead>
                <tr>
                  ...
                  <th class="wd-40p">Heading</th>
                  <th class="wd-20p">Image Preview</th>
