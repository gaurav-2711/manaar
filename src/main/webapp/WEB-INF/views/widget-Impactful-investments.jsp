      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          <div class="az-content-breadcrumb">
            <span>Content</span>
            <span>Widget</span>
            <span>Widget Impactful Investments</span>
          </div>

          <div class="row">
            <div class="col-md-9">
              <h2 class="az-content-title">Widget Impactful Investments</h2>
            </div>
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <input class="form-control" placeholder="Impactful investments" type="text" />
              <textarea
                rows="2"
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Utilizing more than a decade of combined commercial and technical experience in developing energy projects & ventures.
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <textarea
                ...
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Detail (120 Characters)"></textarea>
            </div>
            <!-- col -->
          </div>
