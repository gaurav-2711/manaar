    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row">
            <div class="col-md-9">
              <h2 class="az-content-title">Widget Numbers</h2>
            </div>
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <input class="form-control" placeholder="Widget Impactful Investments" type="text" />
            </div>
            <!-- col-4 -->
          </div>
          <!-- row -->
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label"><span class="spaninfo">Box one</span></div>
              <input class="form-control" placeholder="50+" type="text" />
              <textarea
                rows="2"
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Government & Private Enterprise Clients"></textarea>
            </div>
            <!-- col -->
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label"><span class="spaninfo">Box Two</span></div>
              <input class="form-control" placeholder="50+" type="text" />
              <textarea
                rows="2"
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Global Energy Projects and Ventures Advised."></textarea>
            </div>
            <!-- col -->
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label"><span class="spaninfo">Box Three</span></div>
              <input class="form-control" placeholder="500+" type="text" />
              <textarea
                rows="2"
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Unique Studies and Analytical Products"></textarea>
            </div>
            <!-- col -->
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label"><span class="spaninfo">Box Four</span></div>
              <input class="form-control" placeholder="$1B+" type="text" />
              <textarea
                rows="2"
                id="faq-01-answer"
                class="form-control mg-t-20"
                placeholder="Cumulative Value of Investment Ventures Advised & Developed"></textarea>
            </div>
            <!-- col -->
          </div>
