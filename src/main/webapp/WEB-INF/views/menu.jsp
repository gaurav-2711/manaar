            ...
            <table class="table table-hover mg-b-0">
              <thead>
                <tr>
                  ...
                  <th class="wd-30p">Parent Menu</th>
                  <th class="wd-30p">Menu Label</th>
                  <th class="wd-30p">Alias</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-icon-list">
                      <button class="btn btn-primary btn-icon"><i class="typcn typcn-edit"></i></button>
                      <button class="btn btn-primary btn-icon"><i class="typcn typcn-delete-outline"></i></button>
                    </div>
                  </td>
                </tr>
                <tr>
          ...
          <div class="row row-sm">
            <div class="col-lg-12 mg-t-20 text-lg-right">
              <div class="btn-group" role="group" aria-label="Basic example">
                <button type="button" class="btn btn-secondary btn-icon active">1</button>
                <button type="button" class="btn btn-secondary btn-icon">2</button>
                <button type="button" class="btn btn-secondary btn-icon">3</button>
              </div>
            </div>
            <!-- col-2 -->
          </div>
