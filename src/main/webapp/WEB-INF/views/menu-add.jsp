      ...
      <div class="container">
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row mg-b-40">
            <div class="col-md-9">
              <h2 class="az-content-title">Add Menu</h2>
            </div>
          </div>

          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="az-content-label">Parent</div>
            ...
            <div class="col-lg-6">
              <div class="az-content-label">Menu Label</div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="az-content-label">Menu Type</div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6">
              <div class="az-content-label">Select Page</div>
              <select class="form-control select2-no-search">
                <option label="Choose one"></option>
