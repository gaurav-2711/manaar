      ...
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          <div class="az-content-breadcrumb">
            <span>Content</span>
            <span>Widget</span>
            <span>Widget Manaar's MENA Expansion</span>
          </div>

          <div class="row">
            <div class="col-md-9">
              <h2 class="az-content-title">Widget Manaar's MENA Expansion</h2>
            </div>
          </div>
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <input class="form-control" placeholder="Manaar's MENA Expansion" type="text" />
            </div>
            <!-- col-4 -->
          </div>
          <!-- row -->
          ...
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              ...
              <textarea
                ...
                placeholder="Our activities began in the UAE, where our rapid growth allowed us to expand to Iraq and Saudi Arabia. This also allowed gave us a strong edge in working throughout the MENA region"></textarea>
            </div>
            <!-- col -->
          </div>
          <div class="row row-sm mg-b-20">
            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
              <div class="az-content-label mg-b-5">Image</div>
